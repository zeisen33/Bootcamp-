// can't find what's wrong with commented out part
...
//     const startPipeX = this.dimensions.width + (CONSTANTS.WARM_UP_SECONDS * 60 * CONSTANTS.PIPE_SPEED)
...
//       this.pipes.push(this.createPipe(newX));
//     }
//   }
...
//   createPipe(x) {
//     const heightRange = this.dimensions.height - (2 * CONSTANTS.EDGE_BUFFER) - CONSTANTS.GAP;
